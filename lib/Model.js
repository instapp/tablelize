...
class Model {
    ...
    find(query, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            query = query || {};
            opts = opts || {};
            opts.direction = opts.direction || tablestore_1.default.Direction.FORWARD;
            let params;
            if (query.tableName && query.inclusiveStartPrimaryKey && query.exclusiveEndPrimaryKey) {
                ...
                for (const col of this.schema.columns) {
                    ...
                    if (col.primaryKey) {
                        ...
                        if (typeof value === 'undefined' || value === null) {
                            itemStart[col.name] = (opts.direction === tablestore_1.default.Direction.FORWARD) ? tablestore_1.default.INF_MIN : tablestore_1.default.INF_MAX;
                            itemEnd[col.name] = (opts.direction === tablestore_1.default.Direction.FORWARD) ? tablestore_1.default.INF_MAX : tablestore_1.default.INF_MIN;
                        }
                        else if (typeof value === 'object') {
